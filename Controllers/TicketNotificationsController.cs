...
namespace Bug_Tracker.Controllers
{
    public class TicketNotificationsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,TicketId,UserId,Created,NotificationBody,IsRead")] TicketNotification ticketNotification)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,TicketId,UserId,Created,NotificationBody,IsRead")] TicketNotification ticketNotification)
        {
            if (ModelState.IsValid)
            {
