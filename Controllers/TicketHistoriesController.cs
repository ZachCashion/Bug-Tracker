...
namespace Bug_Tracker.Controllers
{
    public class TicketHistoriesController : Controller
    {
        ...
        {
            ViewBag.TicketId = new SelectList(db.Tickets, "Id", "SubmiterId");
        ...
        public ActionResult Create([Bind(Include = "Id,TicketId,UserId,Updated,Propery,OldValue,NewValue")] TicketHistory ticketHistory)
        {
            ...
            ViewBag.TicketId = new SelectList(db.Tickets, "Id", "SubmiterId", ticketHistory.TicketId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,TicketId,UserId,Updated,Propery,OldValue,NewValue")] TicketHistory ticketHistory)
        {
            if (ModelState.IsValid)
            {
